        ...
        <section class="our_cakes_area p_100">
        	<div class="container">
        		<div class="main_title">
        			<h2>Our Cakes</h2>
        			<h5>"Explore our delightful assortment of cakes,each crafted with the finest ingredients to bring you the perfect balance of flavor and texture. From classic favorites to unique creations, there's a cake for every occasion".</h5>
        		</div>
...
<?php }?>
    ...
    if ($total_no_of_pages <= 10){       
        for ($counter = 1; $counter <= $total_no_of_pages; $counter++){
            if ($counter == $page_no) {
           echo "<li class='active'><a>$counter</a>&nbsp&nbsp</li>";  
                }else{
           echo "<li><a href='?page_no=$counter'>$counter</a>&nbsp&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>";
                }
        }
    }
    ...
    if($page_no <= 4) {         
     for ($counter = 1; $counter < 8; $counter++){       
           ...
           echo "<li><a href='?page_no=$counter'>$counter</a>&nbsp</li>";
                }
        }
        echo "<li><a>...</a></li>";
        echo "<li><a href='?page_no=$second_last'>$second_last</a>&nbsp</li>";
        echo "<li><a href='?page_no=$total_no_of_pages'>$total_no_of_pages</a>&nbsp</li>";
        }
