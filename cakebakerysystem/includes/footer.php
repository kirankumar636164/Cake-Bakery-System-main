                ...
                <div class="row newsletter_inner">
                    ...
                    <div class="col-lg-6">
                        <div class="newsletter_form">
                            <form method="post" onsubmit="return validateForm();" name = "subscribe">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Enter your email address" name="email"  required="true" pattern="/^[a-zA-Z0-9._-]+@gmail\.com$/0">
