            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="cart.php?delid=<?php echo $row['ID'];?>" onclick="return confirm('Do you really want to remove this item from cart?');"><i class="fa fa-trash fa-delete" aria-hidden="true"></i></a></td>
                    </tr>
                    <?php 
                        }
                    } else { ?>
                    <tr>
                        <td colspan="6" style="text-align: center; color: #000; font-weight: bold;">Your cart is empty.</td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
